                    ...
                    <div class="faq-grds">
                        ...
                        <div class="faq-grd-item">
                          <div class="faq-accordion-menu active">
                            <div class="faq-accordion-hdr">
                              <h3 class="faq-accordion-title fl-h5">Implant Referrals</h3>
                            ...
                            <div class="faq-accordion-des active">
                              <p>We are happy to undertake any level of Implant Dentistry for your patients that you would like us to do including patient assessment, implant placement, bone grafting and sinus lift/augmentation or a full implant case referral. Here at Cox and Hitchcock we strive to look after your patient and can keep you involved in the treatment process if you wish. If you would like to discuss any of your patients needs at any point please dont hesistate to contact us.</p>
                      ...
                      <div class="faq-grd">
                        <div class="faq-grd-item">
                          <div class="faq-accordion-menu">
                            <div class="faq-accordion-hdr">
                              <h3 class="faq-accordion-title fl-h5">CBCT Scan Referrals</h3>
                              <div class="faq-accordion-icon-box">
                                <i class="faq-icon">
                                  <svg class="faq-list-icon-svg" width="14" height="8" viewBox="0 0 14 8" fill="none">
                                    <use xlink:href="#faq-list-icon-svg"></use> 
                      ...
                      <div class="faq-grd">
                        <div class="faq-grd-item">
                          <div class="faq-accordion-menu">
                            <div class="faq-accordion-hdr">
                              <h3 class="faq-accordion-title fl-h5">Endodontic Referrals</h3>
                              <div class="faq-accordion-icon-box">
                                <i class="faq-icon">
                                  <svg class="faq-list-icon-svg" width="14" height="8" viewBox="0 0 14 8" fill="none">
                                    <use xlink:href="#faq-list-icon-svg"></use> 
                      ...
                      <div class="faq-grd">
                        <div class="faq-grd-item">
                          <div class="faq-accordion-menu">
                            <div class="faq-accordion-hdr">
                              <h3 class="faq-accordion-title fl-h5">Surgical Referrals</h3>
                              <div class="faq-accordion-icon-box">
                                <i class="faq-icon">
                                  <svg class="faq-list-icon-svg" width="14" height="8" viewBox="0 0 14 8" fill="none">
                                    <use xlink:href="#faq-list-icon-svg"></use> 
